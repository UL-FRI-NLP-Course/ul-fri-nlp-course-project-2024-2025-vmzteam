...
test_data_folder = "/Users/matija.tomazic/Documents/Faks/ONJ/project_local/test_data"
...
def sestavi_prompt(vrstica):
    ...
    try:
        ...
        file_name = f"TMP_{day}_{month}_{time_formatted}.rtf"
